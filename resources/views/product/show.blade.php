    ...
    <div class="container px-4 px-lg-5 my-5">
        <div class="row gx-4 gx-lg-5 align-items-center">
            <div class="col-md-6"><img class="card-img-top mb-5 mb-md-0"
                    src="{{ asset('/assets/img/'.$viewData['product']['image'])}}" alt="..." /></div>
            <div class="col-md-6">
                <h1 class="display-5 fw-bolder"> {{$viewData['product']['name']}} </h1>
                <div class="fs-5 mb-5">
                    <span>${{$viewData['product']['price']}} </span>
                </div>
                <p class="lead"> {{$viewData['product']['description']}} <br> Lorem ipsum dolor sit amet consectetur
                ...
                <div class="d-flex">
                    <input class="form-control text-center me-3" id="inputQuantity" type="num"
                        value="{{ $viewData['product']['quantity']}}" style="max-width: 3rem" />
